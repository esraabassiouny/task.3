...
import 'package:ecommerce/Screens/categories/fragrances.dart';
import 'package:ecommerce/Screens/categories/groceries.dart';
import 'package:ecommerce/Screens/categories/home-decoration.dart';
import 'package:ecommerce/Screens/categories/laptops.dart';
import 'package:ecommerce/Screens/categories/skincare.dart';
import 'package:ecommerce/Screens/categories/smartphones.dart';
import 'package:ecommerce/data_provider/remote_data/dio_helper.dart';
...
final List<Widget> Category_screens = [
  Laptop(),
  Smartphones(),
  Fragrances(),
  Skincare(),
    ...
    child: Column(
      ...
      [
        CircleAvatar(child: Image.asset('${Category.image_url}',height: 100,width: 100,
          ...
          backgroundColor: Colors.brown[100]?.withOpacity(0.4),
          radius: 35,
        ),
        SizedBox(
          height: 7,
